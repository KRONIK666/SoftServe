...
namespace HRManagerApplication.Controllers
{
    public class JuniorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Position,Salary,City,E_mail,Phone,ProjectID,ManagerID")] Junior junior)
        {
            ...
            ViewBag.ProjectID = new SelectList(db.Projects, "ID", "Project_Name", junior.ProjectID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Position,Salary,City,E_mail,Phone,ProjectID,ManagerID")] Junior junior)
        {
            if (ModelState.IsValid)
            {
