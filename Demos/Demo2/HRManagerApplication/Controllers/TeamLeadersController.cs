...
namespace HRManagerApplication.Controllers
{
    public class TeamLeadersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Position,Salary,City,E_mail,Phone,ProjectID,ManagerID")] TeamLeader teamLeader)
        {
            ...
            ViewBag.ProjectID = new SelectList(db.Projects, "ID", "Project_Name", teamLeader.ProjectID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Position,Salary,City,E_mail,Phone,ProjectID,ManagerID")] TeamLeader teamLeader)
        {
            if (ModelState.IsValid)
            {
